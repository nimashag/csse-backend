...
public class DoctorControllerTest {
    ...
    void getAllDoctors_shouldReturnListOfDoctors() {
        // Arrange
        Doctor doctor1 = new Doctor("1", "Dr. John Doe","john.doe@example.com", "password1",  "Cardiology");
        Doctor doctor2 = new Doctor("2", "Dr. Jane Doe", "jane.doe@example.com", "password2","Dermatology");
    ...
    void getDoctorById_shouldReturnDoctor_whenDoctorExists() {
        // Arrange
        Doctor doctor = new Doctor("1", "Dr. John Doe", "john.doe@example.com", "password1","Cardiology");
    ...
    void updateDoctor_shouldReturnUpdatedDoctor_whenDoctorExists() {
        ...
        Doctor existingDoctor = new Doctor("1", "Dr. John Doe", "john.doe@example.com", "password1","Cardiology");
        Doctor updatedDoctor = new Doctor("1", "Dr. John Smith", "john.smith@example.com", "password2","Neurology");
